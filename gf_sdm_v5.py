...
GF-SDM v5
=========
Conversational Factual AI — Think + Learn + Talk

New in v5:
- THINK: breaks question into concepts, finds related facts, combines
- TALK: conversation with memory of last 5 exchanges
- LEARN: user can teach new facts during conversation
- PARAGRAPH: multi-sentence answers from combined knowledge
- SAVE: learned facts persist across sessions
...
class GFSDMv5:
    def __init__(self):
        ...
        if learned:
            ...
            print(f"[v5] Loaded {len(learned)} learned facts.")
    ...
    def chat(self, user_input):
        ...
        # ── Think and answer
        answer = think(enriched, self.qa_pairs,
        ...
        if answer:
            ...
            if last:
                response = (f"I'm not sure about that. "
                            f"We were talking about {last} — want to explore that?")
            else:
                response = ("I don't have information on that yet. "
                            "You can teach me: say something like "
    ...
    def _detect_teach(self, text):
        ...
        # Ignore questions — don't teach from "what is X"
    ...
    def toggle_thinking(self):
        ...
        return f"Thinking mode {'ON' if self.show_thinking else 'OFF'}."
...
Commands:
  ...
  /stats    — show knowledge base size
  /help     — this help
  quit      — exit
...
if __name__ == "__main__":
    print("=" * 55)
    print("  GF-SDM v5  |  Think + Learn + Talk")
    print("  Pure Python | No dependencies | Termux ready")
    print("=" * 55)
    print(f"  {len(QA_PAIRS)} built-in facts. Type /help for commands.\n")

    ai = GFSDMv5()

    print("--- Demo ---\n")
    for q in ["what is consciousness", "what is a black hole", "what is DNA"]:
        print(f"You: {q}")
